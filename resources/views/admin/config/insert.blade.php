                    ...
                    <div class="col-md-6 col-lg-6 col-xl-6">
                        ...
                        <div class="block block-rounded">
                            <div class="block-header block-header-default">
                                <h3 class="block-title">Adaugare Utilizator</h3>
                            </div>
                            <div class="block-content">
                                <div class="p-sm-3 px-lg-6 px-xxl-5 py-lg-5">
                                    <form class="js-validation-signin" action="{{ route("user.updateOrCreate") }}"
                                        method="POST">
                                        @csrf
                                        <div class="py-3">
                                            <div class="mb-4">
                                        ...
                                        <div class="row mb-4">
                                            <div class="col-md-6 col-xl-5">
                                                <button type="submit" class="btn w-100 btn-alt-primary" value="1"
                                                    name="authorize">
                                                    <i class="fa fa-fw fa-sign-in-alt me-1 opacity-50"></i> Crează
                                                </button>
                                            </div>
                                        </div>
                                    </form>
