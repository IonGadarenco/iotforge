...
One.onLoad(class {
    static initChartsChartJS() {
        ...
        n = {
            ...
            data: n,
            options: {tension: .4}
        })), null !== i && (t = new Chart(i, {type: "bar", data: n})), null !== h && (e = new Chart(h, {
            type: "radar",
            data: n
            ...
            type: "pie",
            data: d
        })), null !== g && (l = new Chart(g, {type: "doughnut", data: d}))
    }
