...
@section("content")
    <form class="row" method="post" enctype="multipart/form-data"
        action="{{ route("admin.consultations.update", $consultation->id) }}" id="add_form">
        @csrf
        @method("PUT")
        <div class="content content-full">
            <div class="block block-rounded">
                <div class="block-header block-header-default">
                    <h3 class="block-title">Editare consultatie</h3>
                    <div class="d-flex justify-content-end">
                        <a href="{{ route("admin.consultations") }}" class="btn btn-outline-secondary me-1">Renunță</a>
                                ...
                                <div class="col-md-4">
                                    <div class="border border-info">
                                        ...
                                        <div class="alert alert-info d-flex justify-content-between align-items-center"
                                            ...
                                            <a href="#"
                                                onclick="DeleteConfirm('{{ route("admin.consultations.delete_image_general", $consultation->id) }}');"
                                                data-target="#deleteContact_{{ $consultation->id }}">
                                        ...
                                        <div class="d-flex justify-content-center">
                                            <img style="max-width: 500px;" class="click-image m-1" id="general_image"
                                                src="{{ $consultation->pictureUrl }}" alt="{{ $consultation->name }}"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="link" id="link"
                                                    placeholder="link.com" value="{{ $consultation->link }}">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="consultant"><i class="fas fa-user"></i> Consultant:</label>
                                                <input type="text" class="form-control" name="consultant" id="consultant"
                                                    placeholder="consultant" value="{{ $consultation->consultant }}">
                                            </div>
                                        </div>
                                    </div>
                                    <hr>
                                                    ...
                                                    <div class="col-6">
                                                        <div class="mb-4">
                                                            ...
                                                            <input type="text" class="form-control" name="ro_name"
                                                                id="ro_name"
                                                                value="{{ $consultation->translate("ro")->name ?? "" }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="mb-4">
                                                    <label class="form-label" for="ro_content">Descriere(RO):</label>
                                                    <textarea id="ro_content" name="ro_content">{{ $consultation->translate("ro")->content ?? "" }}</textarea>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="col-6">
                                                        <div class="mb-4">
                                                            ...
                                                            <input type="text" class="form-control" name="en_name"
                                                                id="en_name"
                                                                value="{{ $consultation->translate("en")->name ?? "" }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="mb-4">
                                                    <label class="form-label" for="en_content">Descriere(EN):</label>
                                                    <textarea id="en_content" name="en_content">{{ $consultation->translate("en")->content ?? "" }}</textarea>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="col-6">
                                                        <div class="mb-4">
                                                            ...
                                                            <input type="text" class="form-control" name="ru_name"
                                                                id="ru_name"
                                                                value="{{ $consultation->translate("ru")->name ?? "" }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="mb-4">
                                                    <label class="form-label" for="ru_content">Descriere(RU):</label>
                                                    <textarea id="ru_content" name="ru_content">{{ $consultation->translate("ru")->content ?? "" }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
@push("scripts")
    <script>
        ...
        function store_image_general() {
            ...
            $.ajax({
                url: "{{ route("admin.consultations.storeImageGeneral", $consultation->id) }}",
                type: "POST",
                headers: {
