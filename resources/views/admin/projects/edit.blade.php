...
@section("content")
    <form class="row" method="post" enctype="multipart/form-data"
        action="{{ route("admin.projects.update", $project->id) }}" id="add_form">
        @csrf
            ...
            <div class="block block-rounded">
                <div class="block-header block-header-default">
                    ...
                    <div class="d-flex justify-content-end">
                        <a href="{{ route("admin.projects") }}" class="btn btn-outline-secondary me-1">Renunță</a>
                            ...
                            <div class="row">
                                <div class="col-md-4 d-flex flex-column">
                                    <div class="border border-info ">
                                        <div class="alert alert-info d-flex justify-content-between align-items-center"
                                            ...
                                            <a href="#"
                                                onclick="DeleteConfirm('{{ route("admin.projects.delete_image_general", $project->id) }}');"
                                                data-target="#deleteContact_{{ $project->id }}">
                                                <i class="far fa-image"></i>&nbsp;→&nbsp;
                                                <i class="far fa-trash-alt text-danger"></i>
                                            </a>
                                        </div>
                                        <div class="d-flex justify-content-center">
                                            <img class="img-fluid m-1" id="general_image" src="{{ $project->pictureUrl }}"
                                                alt="{{ $project->name }}" onclick="$('#uploadPhoto').click();" />
                                        </div>
                                ...
                                <div class="col-lg-8">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="form-label" for="budget"><i class="fas fa-money-bill"></i>
                                                    Buget MDL</label>
                                                <input type="number" class="form-control" placeholder="00.00"
                                                    min="0" name="budget" id="budget"
                                        ...
                                        <div class="tab-content col-md-10">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="mb-4">
                                                            ...
                                                            <input type="text" class="form-control" name="ro_name"
                                                                id="ro_name"
                                                                value="{{ $project->translate("ro")->name ?? "" }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-12">
                                                        <div class="mb-4">
                                                            <label class="form-label" for="ro_funder">Finantator(RO):
                                                            </label>
                                                            <input type="text" class="form-control" name="ro_funder"
                                                                id="ro_funder"
                                                                value="{{ $project->translate("ro")->funder ?? "" }}">
                                                        </div>
                                                    </div>
                                                </div>

                                                <div class="mb-4">
                                                    <label class="form-label" for="ro_content">Scopul
                                                        proiectului(RO):</label>
                                                    <textarea id="ro_content" name="ro_content">{{ $project->translate("ro")->content ?? "" }}</textarea>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="mb-4">
                                                            ...
                                                            <input type="text" class="form-control" name="en_funder"
                                                                id="en_funder"
                                                                value="{{ $project->translate("en")->funder ?? "" }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="mb-4">
                                                    ...
                                                    <textarea id="en_content" name="en_content">{{ $project->translate("en")->content ?? "" }}</textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="block-content tab-pane" id="russian" role="tabpanel"
                                                    ...
                                                    <div class="col-12">
                                                        <div class="mb-4">
                                                            ...
                                                            <input type="text" class="form-control" name="ru_name"
                                                                id="ru_name"
                                                                value="{{ $project->translate("ru")->name ?? "" }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-12">
                                                        <div class="mb-4">
                                                            ...
                                                            <input type="text" class="form-control" name="ru_funder"
                                                                id="ru_funder"
                                                                value="{{ $project->translate("ru")->funder ?? "" }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    <textarea id="ru_content" name="ru_content">{{ $project->translate("ru")->content ?? "" }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
@push("scripts")
    <script>
        ...
        function store_image_general() {
            ...
            $.ajax({
                url: "{{ route("admin.projects.storeImageGeneral", $project->id) }}",
                type: "POST",
                headers: {
